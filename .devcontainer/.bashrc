...
alias testf='(cd ~/app/frontend/resources/scripts && ./test.sh)'
...
__bash_prompt() {
    ...
    PS1="${userpart} ${lightblue}\w ${gitbranch}\[\033[0;33m\]\$ ${removecolor}"
...
if [ -f /home/vscode/app/apiserver/.venv/bin/activate ]; then
    source /home/vscode/app/apiserver/.venv/bin/activate
fi